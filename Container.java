...
public abstract class Container
{
    ...
    public void onCraftGuiOpened(ICrafting p_75132_1_)
    {
        ...
        else
        {
            ...
            p_75132_1_.sendContainerAndContentsToPlayer(this, this.getLastActiveItems());
     ...
     */
    public List getLastActiveItems()
    {
    ...
    public static int calcRedstoneFromInventory(IInventory p_94526_0_)
    {
        ...
        else
        {
            ...
            for (int var3 = 0; var3 < p_94526_0_.getSizeInventory(); ++var3)
            {
                ...
                if (var4 != null)
                {
                    var2 += (float)var4.stackSize / (float)Math.min(p_94526_0_.getLastActiveItemsStackLimit(), var4.getMaxStackSize());
                    ++var1;
                }
            }
