...
public class EntityRenderer implements IResourceManagerReloadListener
{
    ...
    private void setupCameraTransform(float p_78479_1_, int p_78479_2_)
    {
        ...
        var4 = this.mc.player.prevTimeInPortal + (this.mc.player.timeInPortal - this.mc.player.prevTimeInPortal) * p_78479_1_;
    ...
    private void updateLightmap(float p_78472_1_)
    {
        ...
        if (var2 != null)
        {
            for (int var3 = 0; var3 < 256; ++var3)
            {
                ...
                {
                    var16 = this.getNightVisionBrightness(this.mc.player, p_78472_1_);
                    var17 = 1.0F / var13;
    ...
    private void updateFogColor(float p_78466_1_)
    {
        ...
        {
            var23 = this.getNightVisionBrightness(this.mc.player, p_78466_1_);
