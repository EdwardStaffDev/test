...
public abstract class GuiContainer extends GuiScreen
{
    ...
    {
        super.initGui();
        this.mc.player.openContainer = this.field_147002_h;
            ...
            if (isShiftKeyDown())
            {
                if (var4 != null && var4.inventory != null && this.field_146994_N != null)
                {
                    ...
                    while (var11.hasNext())
                    {
                        ...
                        if (var10 != null && var10.canTakeStack(this.mc.player) && var10.getHasStack() && var10.inventory == var4.inventory && Container.func_94527_a(var10, this.field_146994_N, true))
                        {
    ...
    protected void func_146984_a(Slot p_146984_1_, int p_146984_2_, int p_146984_3_, int p_146984_4_)
    {
        ...
        this.mc.playerController.windowClick(this.field_147002_h.windowId, p_146984_2_, p_146984_3_, p_146984_4_, this.mc.player);
    }
    ...
    {
        if (this.mc.player.inventory.getItemStack() == null && this.field_147006_u != null)
        {
    ...
    public void onGuiClosed()
    {
        ...
        {
            this.field_147002_h.onContainerClosed(this.mc.player);
        }
    }
