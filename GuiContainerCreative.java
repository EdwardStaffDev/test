...
public class GuiContainerCreative extends InventoryEffectRenderer
{
    ...
    protected void func_146984_a(Slot p_146984_1_, int p_146984_2_, int p_146984_3_, int p_146984_4_)
    {
        ...
        else
        {
            ...
            {
                for (var10 = 0; var10 < this.mc.player.inventoryContainer.getLastActiveItems().size(); ++var10)
                {
            ...
            else
            {
                ...
                if (field_147058_w == CreativeTabs.tabInventory.getTabIndex())
                {
                    ...
                    else if (p_146984_4_ == 4 && this.mc.player.inventory.getItemStack() != null)
                    {
                    ...
                    {
                        this.mc.player.inventoryContainer.slotClick(p_146984_1_ == null ? p_146984_2_ : ((GuiContainerCreative.CreativeSlot)p_146984_1_).field_148332_b.slotNumber, p_146984_3_, p_146984_4_, this.mc.player);
                ...
                else if (p_146984_4_ != 5 && p_146984_1_.inventory == field_147060_v)
                {
                    ...
                    if (p_146984_4_ == 2)
                    {
                        if (var8 != null && p_146984_3_ >= 0 && p_146984_3_ < 9)
                        {
                            ...
                            this.mc.player.inventory.setInventorySlotContents(p_146984_3_, var9);
                            this.mc.player.inventoryContainer.detectAndSendChanges();
                        }
                ...
                {
                    this.field_147002_h.slotClick(p_146984_1_ == null ? p_146984_2_ : p_146984_1_.slotNumber, p_146984_3_, p_146984_4_, this.mc.player);
    ...
    protected void func_146285_a(ItemStack p_146285_1_, int p_146285_2_, int p_146285_3_)
    {
        if (field_147058_w == CreativeTabs.tabAllSearch.getTabIndex())
        {
            List var4 = p_146285_1_.getTooltip(this.mc.player, this.mc.gameSettings.advancedItemTooltips);
    ...
    protected void func_146976_a(float p_146976_1_, int p_146976_2_, int p_146976_3_)
    {
        ...
        {
            GuiInventory.func_147046_a(this.field_147003_i + 43, this.field_147009_r + 45, 20, (float)(this.field_147003_i + 43 - p_146976_2_), (float)(this.field_147009_r + 45 - 30 - p_146976_3_), this.mc.player);
        }
    }
    ...
    protected void actionPerformed(GuiButton p_146284_1_)
    {
        if (p_146284_1_.id == 0)
        {
            this.mc.displayGuiScreen(new GuiAchievements(this, this.mc.player.func_146107_m()));
        }

        if (p_146284_1_.id == 1)
        {
            this.mc.displayGuiScreen(new GuiStats(this, this.mc.player.func_146107_m()));
        }
    }
