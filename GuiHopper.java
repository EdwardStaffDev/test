...
public class GuiHopper extends GuiContainer
{
    ...
    {
        this.fontRendererObj.drawString(this.field_147083_w.isInventoryNameLocalized() ? this.field_147083_w.getLastActiveItemsName() : I18n.format(this.field_147083_w.getLastActiveItemsName(), new Object[0]), 8, 6, 4210752);
        this.fontRendererObj.drawString(this.field_147084_v.isInventoryNameLocalized() ? this.field_147084_v.getLastActiveItemsName() : I18n.format(this.field_147084_v.getLastActiveItemsName(), new Object[0]), 8, this.field_147000_g - 96 + 2, 4210752);
    }
