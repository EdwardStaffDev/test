...
public class GuiIngame extends Gui
{
    ...
    public void renderGameOverlay(float p_73830_1_, boolean p_73830_2_, int p_73830_3_, int p_73830_4_)
    {
        ...
        {
            this.renderVignette(this.mc.player.getBrightness(p_73830_1_), var6, var7);
        }
        else
        {
        ...
        ItemStack var9 = this.mc.player.inventory.armorItemInSlot(3);
        ...
        {
            float var10 = this.mc.player.prevTimeInPortal + (this.mc.player.timeInPortal - this.mc.player.prevTimeInPortal) * p_73830_1_;
        ...
        if (!this.mc.playerController.enableEverythingIsScrewedUpMode())
        {
            ...
            InventoryPlayer var31 = this.mc.player.inventory;
            this.zLevel = -90.0F;
        ...
        if (this.mc.player.getSleepTimer() > 0)
        {
            ...
            var32 = this.mc.player.getSleepTimer();
        ...
        if (this.mc.player.isRidingHorse())
        {
            ...
            var34 = this.mc.player.getHorseJumpPower();
            var38 = 182;
        ...
        else if (this.mc.playerController.gameIsSurvivalOrAdventure())
        {
            ...
            this.mc.getTextureManager().bindTexture(Gui.icons);
            var12 = this.mc.player.xpBarCap();

            if (var12 > 0)
            {
                var38 = 182;
                var14 = (int)(this.mc.player.experience * (float)(var38 + 1));
                var15 = var7 - 32 + 3;
            ...
            if (this.mc.player.experienceLevel > 0)
            {
                ...
                String var43 = "" + this.mc.player.experienceLevel;
        ...
        if (this.mc.gameSettings.showDebugInfo)
        {
            ...
            var22 = MathHelper.floor_double(this.mc.player.posX);
            var23 = MathHelper.floor_double(this.mc.player.posY);
            int var24 = MathHelper.floor_double(this.mc.player.posZ);
            this.drawString(var8, String.format("x: %.5f (%d) // c: %d (%d)", new Object[] {Double.valueOf(this.mc.player.posX), Integer.valueOf(var22), Integer.valueOf(var22 >> 4), Integer.valueOf(var22 & 15)}), 2, 64, 14737632);
            this.drawString(var8, String.format("y: %.3f (feet pos, %.3f eyes pos)", new Object[] {Double.valueOf(this.mc.player.boundingBox.minY), Double.valueOf(this.mc.player.posY)}), 2, 72, 14737632);
            this.drawString(var8, String.format("z: %.5f (%d) // c: %d (%d)", new Object[] {Double.valueOf(this.mc.player.posZ), Integer.valueOf(var24), Integer.valueOf(var24 >> 4), Integer.valueOf(var24 & 15)}), 2, 80, 14737632);
            int var25 = MathHelper.floor_double((double)(this.mc.player.rotationYaw * 4.0F / 360.0F) + 0.5D) & 3;
            this.drawString(var8, "f: " + var25 + " (" + Direction.directions[var25] + ") / " + MathHelper.wrapAngleTo180_float(this.mc.player.rotationYaw), 2, 88, 14737632);
            ...
            this.drawString(var8, String.format("ws: %.3f, fs: %.3f, g: %b, fl: %d", new Object[] {Float.valueOf(this.mc.player.capabilities.getWalkSpeed()), Float.valueOf(this.mc.player.capabilities.getFlySpeed()), Boolean.valueOf(this.mc.player.onGround), Integer.valueOf(this.mc.theWorld.getHeightValue(var22, var24))}), 2, 104, 14737632);
        ...
        if (this.mc.gameSettings.keyBindPlayerList.getIsKeyPressed() && (!this.mc.isIntegratedServerRunning() || this.mc.player.sendQueue.playerInfoList.size() > 1 || var37 != null))
        {
            this.mc.mcProfiler.startSection("playerList");
            NetHandlerPlayClient var40 = this.mc.player.sendQueue;
    ...
    {
        boolean var3 = this.mc.player.hurtResistantTime / 3 % 2 == 1;
        ...
        int var4 = MathHelper.ceiling_float_int(this.mc.player.getHealth());
        int var5 = MathHelper.ceiling_float_int(this.mc.player.prevHealth);
        this.rand.setSeed((long)(this.updateCounter * 312871));
        boolean var6 = false;
        FoodStats var7 = this.mc.player.getFoodStats();
        int var8 = var7.getFoodLevel();
        int var9 = var7.getPrevFoodLevel();
        IAttributeInstance var10 = this.mc.player.getEntityAttribute(SharedMonsterAttributes.maxHealth);
        int var11 = p_110327_1_ / 2 - 91;
        int var12 = p_110327_1_ / 2 + 91;
        int var13 = p_110327_2_ - 39;
        float var14 = (float)var10.getAttributeValue();
        float var15 = this.mc.player.getAbsorptionAmount();
        int var16 = MathHelper.ceiling_float_int((var14 + var15) / 2.0F / 10.0F);
        int var17 = Math.max(10 - (var16 - 2), 3);
        int var18 = var13 - (var16 - 1) * var17 - 10;
        float var19 = var15;
        int var20 = this.mc.player.getTotalArmorValue();
        int var21 = -1;

        if (this.mc.player.isPotionActive(Potion.regeneration))
        {
        ...
        for (var22 = MathHelper.ceiling_float_int((var14 + var15) / 2.0F) - 1; var22 >= 0; --var22)
        {
            ...
            if (this.mc.player.isPotionActive(Potion.poison))
            {
                var23 += 36;
            }
            else if (this.mc.player.isPotionActive(Potion.wither))
            {
                var23 += 72;
            }
        ...
        Entity var34 = this.mc.player.ridingEntity;
        int var36;
        ...
        if (var34 == null)
        {
            ...
            for (var23 = 0; var23 < 10; ++var23)
            {
                ...
                if (this.mc.player.isPotionActive(Potion.hunger))
                {
                    var25 += 36;
                    var38 = 13;
                }

                if (this.mc.player.getFoodStats().getSaturationLevel() <= 0.0F && this.updateCounter % (var8 * 3 + 1) == 0)
                {
    ...
    {
        ItemStack var5 = this.mc.player.inventory.mainInventory[p_73832_1_];
