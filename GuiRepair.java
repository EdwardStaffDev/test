...
public class GuiRepair extends GuiContainer implements ICrafting
{
    ...
    {
        super(new ContainerRepair(p_i46381_1_, p_i46381_2_, p_i46381_3_, p_i46381_4_, p_i46381_5_, Minecraft.getMinecraft().player));
    ...
    public void initGui()
    {
        ...
        this.field_147002_h.onCraftGuiOpened(this);
    }
    ...
    protected void func_146979_b(int p_146979_1_, int p_146979_2_)
    {
        ...
        if (this.field_147092_v.maximumCost > 0)
        {
            ...
            if (this.field_147092_v.maximumCost >= 40 && !this.mc.player.capabilities.isCreativeMode)
            {
    ...
    private void func_147090_g()
    {
        ...
        this.mc.player.sendQueue.addToSendQueue(new C17PacketCustomPayload("MC|ItemName", var1.getBytes(Charsets.UTF_8)));
    }
