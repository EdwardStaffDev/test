...
public class InventoryLargeChest implements IInventory
{
    ...
    {
        return this.upperChest.isInventoryNameLocalized() ? this.upperChest.getLastActiveItemsName() : (this.lowerChest.isInventoryNameLocalized() ? this.lowerChest.getLastActiveItemsName() : this.name);
    }
    ...
    {
        return this.upperChest.getLastActiveItemsStackLimit();
    }
