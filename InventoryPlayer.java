...
public class InventoryPlayer implements IInventory
{
    ...
    private int storeItemStack(ItemStack p_70432_1_)
    {
        for (int var2 = 0; var2 < this.mainInventory.length; ++var2)
        {
            if (this.mainInventory[var2] != null && this.mainInventory[var2].getItem() == p_70432_1_.getItem() && this.mainInventory[var2].isStackable() && this.mainInventory[var2].stackSize < this.mainInventory[var2].getMaxStackSize() && this.mainInventory[var2].stackSize < this.getLastActiveItemsStackLimit() && (!this.mainInventory[var2].getHasSubtypes() || this.mainInventory[var2].getItemDamage() == p_70432_1_.getItemDamage()) && ItemStack.areItemStackTagsEqual(this.mainInventory[var2], p_70432_1_))
            {
                return var2;
            }
        }
    ...
    private int storePartialItemStack(ItemStack p_70452_1_)
    {
        ...
        else
        {
            ...
            else
            {
                ...
                if (var5 > this.getLastActiveItemsStackLimit() - this.mainInventory[var4].stackSize)
                {
                    var5 = this.getLastActiveItemsStackLimit() - this.mainInventory[var4].stackSize;
                }
     ...
     */
    public String getLastActiveItemsName()
    {
     ...
     */
    public int getLastActiveItemsStackLimit()
    {
        return 64;
    }
