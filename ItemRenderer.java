...
public class ItemRenderer
{
    ...
    public void renderItemInFirstPerson(float p_78440_1_)
    {
        ...
        EntityClientPlayerMP var3 = this.mc.player;
        ...
        if (var8 != null && var8.getItem() == Items.filled_map)
        {
            ...
            for (int var24 = 0; var24 < 2; ++var24)
            {
                ...
                var26 = RenderManager.instance.getEntityRenderObject(this.mc.player);
                var29 = (RenderPlayer)var26;
                var18 = 1.0F;
                GL11.glScalef(var18, var18, var18);
                var29.renderFirstPersonArm(this.mc.player);
                GL11.glPopMatrix();
            }
    ...
    public void renderOverlays(float p_78447_1_)
    {
        ...
        {
            int var2 = MathHelper.floor_double(this.mc.player.posX);
            int var3 = MathHelper.floor_double(this.mc.player.posY);
            int var4 = MathHelper.floor_double(this.mc.player.posZ);
            ...
            else
            {
                ...
                {
                    float var7 = ((float)((var6 >> 0) % 2) - 0.5F) * this.mc.player.width * 0.9F;
                    float var8 = ((float)((var6 >> 1) % 2) - 0.5F) * this.mc.player.height * 0.2F;
                    float var9 = ((float)((var6 >> 2) % 2) - 0.5F) * this.mc.player.width * 0.9F;
    ...
    private void renderWarpedTextureOverlay(float p_78448_1_)
    {
        ...
        float var3 = this.mc.player.getBrightness(p_78448_1_);
        ...
        float var8 = 1.0F;
        float var9 = -0.5F;
        float var10 = -this.mc.player.rotationYaw / 64.0F;
        float var11 = this.mc.player.rotationPitch / 64.0F;
    ...
    public void updateEquippedItem()
    {
        ...
        EntityClientPlayerMP var1 = this.mc.player;
