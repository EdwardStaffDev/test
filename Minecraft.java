...
public class Minecraft implements IPlayerUsage
{
     ...
     * class's 'player' instance. Modification of its location, rotation, or other settings at render time will
    ...
    private void startGame() throws LWJGLException
    {
        ...
        if (var1 != Util.EnumOS.OSX)
        {
            try
            {
                InputStream var2 = this.mcDefaultResourcePack.getInputStream(new ResourceLocation("icons/icon_16x16.png"));
                InputStream var3 = this.mcDefaultResourcePack.getInputStream(new ResourceLocation("icons/icon_32x32.png"));
    ...
    private void runGameLoop()
    {
        ...
        this.mcSoundHandler.func_147691_a(this.player, this.timer.renderPartialTicks);
        ...
        if (this.leftClickCounter <= 0)
        {
            if (p_147115_1_ && this.objectMouseOver != null && this.objectMouseOver.typeOfHit == MovingObjectPosition.MovingObjectType.BLOCK)
            {
                ...
                if (this.theWorld.getBlock(var2, var3, var4).getMaterial() != Material.air)
                {
                    ...
                    if (this.player.isCurrentToolAdventureModeExempt(var2, var3, var4))
                    {
    ...
    private void func_147121_ag()
    {
        ...
        else
        {
            ...
            {
                case 1:
                    if (this.playerController.interactWithEntitySendPacket(this.player, this.objectMouseOver.entityHit))
                    {
                        var1 = false;
                    }
                ...
                case 2:
                    ...
                    if (this.theWorld.getBlock(var3, var4, var5).getMaterial() != Material.air)
                    {
                        ...
                        if (this.playerController.onPlayerRightClick(this.player, this.theWorld, var2, var3, var4, var5, this.objectMouseOver.sideHit, this.objectMouseOver.hitVec))
                        {
                            var1 = false;
                            this.player.swingItem();
                        }
        ...
        if (var1)
        {
            ItemStack var7 = this.player.inventory.getCurrentItem();

            if (var7 != null && this.playerController.sendUseItem(this.player, this.theWorld, var7))
            {
    ...
    public void runTick()
    {
        ...
        if (this.currentScreen == null || this.currentScreen.field_146291_p)
        {
            ...
            for (var9 = 0; var9 < 9; ++var9)
            {
                ...
                {
                    this.player.inventory.currentItem = var9;
                }
            }
        ...
        if (this.theWorld != null)
        {
            ...
            if (!this.isGamePaused && this.theWorld != null)
            {
                this.theWorld.doVoidFogParticles(MathHelper.floor_double(this.player.posX), MathHelper.floor_double(this.player.posY), MathHelper.floor_double(this.player.posZ));
            }
    ...
    public void loadWorld(WorldClient p_71353_1_, String p_71353_2_)
    {
        ...
        if (p_71353_1_ != null)
        {
            ...
            if (this.player == null)
            {
                this.player = this.playerController.func_147493_a(p_71353_1_, new StatFileWriter());
                this.playerController.flipPlayer(this.player);
            }

            this.player.preparePlayerToSpawn();
            p_71353_1_.spawnEntityInWorld(this.player);
    ...
    public void setDimensionAndSpawnPlayer(int p_71354_1_)
    {
        ...
        if (this.player != null)
        {
            ...
            var3 = this.player.func_142021_k();
        }

        this.renderViewEntity = null;
        this.player = this.playerController.func_147493_a(this.theWorld, this.player == null ? new StatFileWriter() : this.player.func_146107_m());
        this.player.dimension = p_71354_1_;
        this.renderViewEntity = this.player;
        this.player.preparePlayerToSpawn();
        this.player.func_142020_c(var3);
    ...
    private void func_147112_ai()
    {
        if (this.objectMouseOver != null)
        {
            ...
            this.player.inventory.func_146030_a(var2, var3, var4, var1);

            if (var1)
            {
                var5 = this.player.inventoryContainer.inventorySlots.size() - 9 + this.player.inventory.currentItem;
                this.playerController.sendSlotPacket(this.player.inventory.getStackInSlot(this.player.inventory.currentItem), var5);
            }
        }
    }
    ...
    public void addServerStatsToSnooper(PlayerUsageSnooper p_70000_1_)
    {
        ...
        p_70000_1_.func_152768_a("run_time", Long.valueOf((MinecraftServer.getCurrentTimeMillis() - p_70000_1_.getMinecraftStartTimeMillis()) / 60L * 1000L));
