...
public class PlayerControllerMP
{
    ...
    {
        if (!p_78744_0_.theWorld.extinguishFire(p_78744_0_.player, p_78744_2_, p_78744_3_, p_78744_4_, p_78744_5_))
        {
    ...
    {
        if (this.currentGameType.isAdventure() && !this.mc.player.isCurrentToolAdventureModeExempt(p_78751_1_, p_78751_2_, p_78751_3_))
        {
            return false;
        }
        else if (this.currentGameType.isCreative() && this.mc.player.getHeldItem() != null && this.mc.player.getHeldItem().getItem() instanceof ItemSword)
        {
            return false;
        }
        else
        {
            ...
            else
            {
                ...
                {
                    ItemStack var9 = this.mc.player.getCurrentEquippedItem();

                    if (var9 != null)
                    {
                        var9.func_150999_a(var5, var6, p_78751_1_, p_78751_2_, p_78751_3_, this.mc.player);
    ...
    {
        if (!this.currentGameType.isAdventure() || this.mc.player.isCurrentToolAdventureModeExempt(p_78743_1_, p_78743_2_, p_78743_3_))
        {
            if (this.currentGameType.isCreative())
            {
            ...
            else if (!this.isHittingBlock || !this.sameToolAndBlock(p_78743_1_, p_78743_2_, p_78743_3_))
            {
                ...
                {
                    var5.onBlockClicked(this.mc.theWorld, p_78743_1_, p_78743_2_, p_78743_3_, this.mc.player);
                }

                if (var6 && var5.getPlayerRelativeBlockHardness(this.mc.player, this.mc.player.worldObj, p_78743_1_, p_78743_2_, p_78743_3_) >= 1.0F)
                {
                ...
                else
                {
                    ...
                    this.mc.theWorld.destroyBlockInWorldPartially(this.mc.player.getEntityId(), this.currentBlockX, this.currentBlockY, this.currentblockZ, (int)(this.curBlockDamageMP * 10.0F) - 1);
                }
            }
        }
    }
    ...
    public void resetBlockRemoving()
    {
        ...
        this.curBlockDamageMP = 0.0F;
        this.mc.theWorld.destroyBlockInWorldPartially(this.mc.player.getEntityId(), this.currentBlockX, this.currentBlockY, this.currentblockZ, -1);
    }
    ...
    public void onPlayerDamageBlock(int p_78759_1_, int p_78759_2_, int p_78759_3_, int p_78759_4_)
    {
        ...
        else
        {
            if (this.sameToolAndBlock(p_78759_1_, p_78759_2_, p_78759_3_))
            {
                ...
                this.curBlockDamageMP += var5.getPlayerRelativeBlockHardness(this.mc.player, this.mc.player.worldObj, p_78759_1_, p_78759_2_, p_78759_3_);

                if (this.stepSoundTickCounter % 4.0F == 0.0F)
                {
                    this.mc.getSoundHandler().playSound(new PositionedSoundRecord(new ResourceLocation(var5.stepSound.getStepResourcePath()), (var5.stepSound.getVolume() + 1.0F) / 8.0F, var5.stepSound.getFrequency() * 0.5F, (float)p_78759_1_ + 0.5F, (float)p_78759_2_ + 0.5F, (float)p_78759_3_ + 0.5F));
                }
    ...
    {
        ItemStack var4 = this.mc.player.getHeldItem();
