...
public class RenderFish extends Render
{
    ...
    public void doRender(EntityFishHook p_76986_1_, double p_76986_2_, double p_76986_4_, double p_76986_6_, float p_76986_8_, float p_76986_9_)
    {
        ...
        if (p_76986_1_.field_146042_b != null)
        {
            ...
            double var29 = p_76986_1_.field_146042_b == Minecraft.getMinecraft().player ? 0.0D : (double)p_76986_1_.field_146042_b.getEyeHeight();

            if (this.renderManager.options.thirdPersonView > 0 || p_76986_1_.field_146042_b != Minecraft.getMinecraft().player)
            {
