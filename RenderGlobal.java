...
public class RenderGlobal implements IWorldAccess
{
    ...
    public void renderEntities(EntityLivingBase p_147589_1_, ICamera p_147589_2_, float p_147589_3_)
    {
        ...
        else
        {
            ...
            for (var18 = 0; var18 < var17.size(); ++var18)
            {
                ...
                boolean var20 = var19.isInRangeToRender3d(var4, var6, var8) && (var19.ignoreFrustumCheck || p_147589_2_.isBoundingBoxInFrustum(var19.boundingBox) || var19.riddenByEntity == this.mc.player);
    ...
    public void renderSky(float p_72714_1_)
    {
        ...
        else if (this.mc.theWorld.provider.isSurfaceWorld())
        {
            ...
            double var25 = this.mc.player.getPosition(p_72714_1_).yCoord - this.theWorld.getHorizon();
