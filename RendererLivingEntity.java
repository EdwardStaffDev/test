...
public abstract class RendererLivingEntity extends Render
{
    ...
    protected void renderModel(EntityLivingBase p_77036_1_, float p_77036_2_, float p_77036_3_, float p_77036_4_, float p_77036_5_, float p_77036_6_, float p_77036_7_)
    {
        ...
        else if (!p_77036_1_.isInvisibleToPlayer(Minecraft.getMinecraft().player))
        {
            GL11.glPushMatrix();
    ...
    {
        return Minecraft.isGuiEnabled() && p_110813_1_ != this.renderManager.livingPlayer && !p_110813_1_.isInvisibleToPlayer(Minecraft.getMinecraft().player) && p_110813_1_.riddenByEntity == null;
    }
