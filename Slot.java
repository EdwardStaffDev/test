...
public class Slot
{
    ...
    /**
     * Returns the maximum stack size for a given slot (usually the same as getLastActiveItemsStackLimit(), but 1 in the case
     * of armor slots)
     */
    public int getSlotStackLimit()
    {
        return this.inventory.getLastActiveItemsStackLimit();
    }
