        ...
        for (int var3 = 0; var3 < this.craftMatrix.getSizeInventory(); ++var3)
        {
            ...
            if (var4 != null)
            {
                ...
                if (var4.getItem().hasContainerItem())
                {
                    ...
                    if (!var4.getItem().doesContainerItemLeaveCraftingGrid(var4) || !this.player.inventory.addItemStackToInventory(var5))
                    {
                        ...
                        {
                            this.player.dropPlayerItemWithRandomChoice(var5, false);
                        }
                    }
                }
            }
