...
public class Stitcher
{
    ...
    {
        private final TextureAtlasSprite backgroundImageName;
        ...
        {
            this.backgroundImageName = p_i45094_1_;
        ...
        public int compareTo(Stitcher.Holder p_compareTo_1_)
        {
            ...
            if (this.getHeight() == p_compareTo_1_.getHeight())
            {
                ...
                {
                    if (this.backgroundImageName.getIconName() == null)
                    {
                        return p_compareTo_1_.backgroundImageName.getIconName() == null ? 0 : -1;
                    }

                    return this.backgroundImageName.getIconName().compareTo(p_compareTo_1_.backgroundImageName.getIconName());
                }
