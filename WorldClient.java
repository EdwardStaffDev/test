...
public class WorldClient extends World
{
    ...
    {
        return (Entity)(p_73045_1_ == this.mc.player.getEntityId() ? this.mc.player : (Entity)this.entityHashSet.lookup(p_73045_1_));
    }
    ...
    public CrashReportCategory addWorldInfoToCrashReport(CrashReport p_72914_1_)
    {
        ...
        var2.addCrashSectionCallable("Server brand", new Callable()
        {
            ...
            public String call()
            {
                return WorldClient.this.mc.player.func_142021_k();
            }
        });
